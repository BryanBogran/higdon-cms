 ...
 * group in the dropdown — and `accounting`, `staff` and `test` stay
 * gone. That is the difference between a roster and a pile of strings.
 *
 ...
 */
export const DESKS = ['Records', 'Scheduling', 'Receptionist'];
