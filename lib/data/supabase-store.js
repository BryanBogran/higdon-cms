...
export function createSupabaseStore(client) {
  ...
  return {
     ...
     *   it removes the audit history, which has no foreign key and would
     *     otherwise keep the "deleted" case in the database in all but name;
     *   it writes the single tombstone that replaces that history.
     *
