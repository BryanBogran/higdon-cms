...
export const COLUMN_MIN_WIDTH = {
  ...
  textarea: 320,
  /*
   * 250, not 170. "Defendant's Initial Disclosures" and "Requests for
   * Production" were both cut to "Requests for Di..." -- a dropdown you have
   * to open to read is not a dropdown you can scan, and two of the discovery
   * types differ only in their last word.
   *
   * 280 rather than the 250 that just fit: the longest option measured 195px
   * of text in 202px of usable box, and 7px of headroom truncates on any
   * machine whose font renders a shade wider. Cutting a dropdown at
   * "Defendant's Initial Disclo..." is exactly the failure this widening was
   * for.
   */
  select: 280,
